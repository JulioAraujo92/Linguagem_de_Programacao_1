...
public class DivisaoFracao {
    ...
    public static void main(String[] args) {
        ...
        // Divide a primeira fração pela segunda
    ...
    static class Fracao {
        ...
        // Método para dividir esta fração por outra fração
        public Fracao dividir(Fracao outra) {
            // O numerador da fração resultante é o produto do numerador desta fração e do denominador da outra fração
            int novoNumerador = this.numerador * outra.denominador;
            // O denominador da fração resultante é o produto do denominador desta fração e do numerador da outra fração
